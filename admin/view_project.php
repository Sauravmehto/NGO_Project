		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				...
				<?php }
					...
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="emp_reply"><i class="fa fa-plus"></i> Reply </button>
					</div>
                  <?php
				}?>
				</div>
				<div class="card-body p-0">
					...
					<table class="table table-condensed m-0 table-hover">
						...
						<tbody>
							...
							$tasks = $conn->query("SELECT * FROM user_reply where project_id = $id order by id desc");
...
<script>
	...
	$('#emp_reply').click(function(){
		uni_modal("Reply to <?php echo ucwords($name) ?>","emp_reply.php?id=<?php echo $id ?>","mid-large")
	})
